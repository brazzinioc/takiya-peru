<?php $__env->startSection('page-title', 'Edición de Género Musical'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container px-4 lg:px-0 py-10">
        ...
        <form action="<?php echo e(route('dashboard.musicgenres.update', $musicGenre)); ?>" method="POST" class="my-2">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/musicGenres/edit.blade.php ENDPATH**/ ?>