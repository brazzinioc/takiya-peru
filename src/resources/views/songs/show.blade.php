...
@section('content')
    ...
    <div class="song-image-cover flex px-4 lg:px-8 py-10" style="background-image: url('{{$urlImage}}')">
        <div class="bg-white text-black p-5 place-self-end w-full lg:w-auto border shadow">
            <h1 class="font-medium text-purple-700 text-2xl mb-1">{{strtoupper($song->title)}}</h1>
            ...
            <p class="text-xs lg:text-base font-light"> <small> Actualización: <span class=""> {{ $song->updated_at->diffForHumans() }} </span> </small></p>
        </div>
    </div>
